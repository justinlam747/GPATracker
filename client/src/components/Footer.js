            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            <span className="text-xl font-semibold text-blue-900">GPAConnect</span>
                        </div>
                        ...
                        <p className="text-xs text-blue-400/60">
                            &copy; {new Date().getFullYear()} GPAConnect. All rights reserved.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link
                                    to="/terms-of-service"
                                    className="text-sm text-blue-400 hover:text-blue-800 transition-colors flex items-center space-x-2"
                                >
                ...
                <div className="mt-8 pt-8 border-t border-white/40">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <div className="flex items-center space-x-6 text-xs text-blue-400/60">
                        ...
                        <div className="flex items-center space-x-2 text-xs text-blue-400/60">
