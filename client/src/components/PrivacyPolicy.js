                    ...
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <h1 className="text-2xl font-bold text-blue-900">Privacy Policy</h1>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="card-3d-static rounded-2xl p-8">
                        ...
                        <div className="prose max-w-none">
                            ...
                            <div className="insight-display rounded-xl p-4 mb-6">
                            ...
                            <h2 className="text-xl font-semibold text-blue-900 mb-4">3. Data Security</h2>
                            <div className="insight-display rounded-xl p-4 mb-6">
                                <div className="flex items-start space-x-3">
                            ...
                            <h2 className="text-xl font-semibold text-blue-900 mb-4">4. Data Sharing and Disclosure</h2>
                            <p className="text-blue-600/70 mb-6">
                            ...
                            <h2 className="text-xl font-semibold text-blue-900 mb-4">5. Data Retention</h2>
                            <p className="text-blue-600/70 mb-6">
                                We retain your personal information for as long as your account is active or as needed to provide services.
                                You may request deletion of your account and associated data at any time.
                            </p>

                            <h2 className="text-xl font-semibold text-blue-900 mb-4">6. Your Rights and Choices</h2>
                            <div className="insight-display rounded-xl p-4 mb-6">
                                <p className="text-blue-900 text-sm font-medium mb-2">
                                    You have the right to:
                                </p>
                                <ul className="list-disc pl-6 text-blue-600/70 text-sm space-y-1">
                            ...
                            <h2 className="text-xl font-semibold text-blue-900 mb-4">7. Cookies and Tracking</h2>
                            <p className="text-blue-600/70 mb-6">
                            ...
                            <h2 className="text-xl font-semibold text-blue-900 mb-4">9. Children's Privacy</h2>
                            <p className="text-blue-600/70 mb-6">
                            ...
                            <h2 className="text-xl font-semibold text-blue-900 mb-4">10. International Data Transfers</h2>
                            <p className="text-blue-600/70 mb-6">
                                Your information may be transferred to and processed in countries other than your own. We ensure
                                appropriate safeguards are in place to protect your data in accordance with this Privacy Policy.
                            </p>

                            <h2 className="text-xl font-semibold text-blue-900 mb-4">11. Changes to This Policy</h2>
                            <p className="text-blue-600/70 mb-6">
                                We may update this Privacy Policy from time to time. We will notify you of any material changes
                                by posting the new policy on this page and updating the "Last updated" date.
                            </p>

                            <h2 className="text-xl font-semibold text-blue-900 mb-4">12. Contact Us</h2>
                            <p className="text-blue-600/70 mb-6">
